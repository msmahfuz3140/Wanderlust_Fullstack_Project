...
const LoginPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (error) {
                setError(error.message || "<SignIn></SignIn> failed");
                return;
            }
        ...
        <div className="min-h-screen bg-slate-50/50 flex flex-col justify-center items-center py-10 px-4 sm:px-6 lg:px-8 font-sans antialiased">
            ...
            <div className="text-center mb-6 max-w-md w-full">
                ...
                <p className="text-sm sm:text-base text-slate-500 mt-2">
                    Continue your adventure with <span className="font-medium text-[#149fc6]">Wanderlust</span>
                </p>
            </div>
            ...
            <div className="bg-white p-6 sm:p-10 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.02)] border border-slate-100/80 w-full max-w-[460px] transition-all duration-300">
                    ...
                    <div className="flex items-center justify-between pt-1">
                        <div className="flex items-center">
                            <input
                                ...
                                onChange={handleChange}
                                className="h-4 w-4 text-[#149fc6] focus:ring-[#149fc6] border-slate-300 rounded cursor-pointer"
                            />
                            <label htmlFor="rememberMe" className="ml-2 block text-xs sm:text-sm text-slate-600 cursor-pointer select-none">
                                Remember me
                            </label>
                        </div>
                        <div className="text-xs sm:text-sm">
                            <a href="/forgot-password" className="font-medium text-[#149fc6] hover:text-[#1083a4] hover:underline transition-colors">
                                Forgot password?
                            </a>
                        </div>
                    </div>
                ...
                <div className="relative my-6">
                    ...
                    <div className="relative flex justify-center text-xs">
                        <span className="px-3 bg-white text-slate-400 font-medium tracking-wide uppercase">Or sign in with</span>
                    </div>
                </div>
                ...
                <div className="text-center mt-6 text-sm text-slate-500">
                    ...
                    <a href="/signup" className="text-[#149fc6] hover:text-[#1083a4] hover:underline font-semibold transition-colors ml-1">
                        Sign Up
                    </a>
                </div>
            </div>
